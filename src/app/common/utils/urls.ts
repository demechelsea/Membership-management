...
export class Urls {
    ...
    public static SECURITY_REFRESH_TOKEN: string = Urls.baseAPIUrl + Urls.contextPath + "/authenticate/refreshAuthToken";
    ...
    public static CREATE_ASSOCIATION: string = Urls.baseAPIUrl + Urls.contextPath + "/association/createAssociation";
    public static RETRIEVE_MAPPED_ASSOCIATION: string = Urls.baseAPIUrl + Urls.contextPath + "/association/retrieveMappedAssoications";
    public static FETCH_ASSOC_BY_CONTEXTPATH: string = Urls.baseAPIUrl + Urls.contextPath + "/association/retrieveAssoication";
    public static FETCH_ASSOC_BY_NAME_AND_PLACE: string = Urls.baseAPIUrl + Urls.contextPath + "/association/retrieveAssoicationNameAndPlace";
    public static FETCH_ASSOC_BY_SEARCH_TEXT: string = Urls.baseAPIUrl + Urls.contextPath + "/association/retrieveAllAssoications";
    public static USER_BELONGS_TO_ASSOICATION:string = Urls.baseAPIUrl + Urls.contextPath +"/association/validUserAssoication";  
